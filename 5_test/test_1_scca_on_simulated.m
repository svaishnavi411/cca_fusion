...
load_file_prefix = strcat(base_dir, '9_simulated_data/');
save_file_prefix = strcat(base_dir, '7_results/simulation_scca/');
save_file_name = strcat(save_file_prefix, 'results_scca.txt');
    ...
    for degree = degree_settings
        for sigma_factor = sigma_settings
            ...
            for itr = 1:25
                ...
                result_folder = strcat(save_file_prefix, num2str(degree), '_', num2str(sigma_factor*100));
